                                        ...
                                        <>
                                            ...
                                            <div className="ordr-chk-box">
                                                ...
                                                <div style={{
                                                    ...
                                                    Annual Per Capita. Fully paid Life and Legacy Life members shall pay a twenty-five dollar ($25.00) per capita fee annually. New Life and Legacy Life members shall pay the yearly per capita fee one (1) year after full payment
                                                </div>
                                            </div>
                                            ...
                                            <div className="form-row">
                                                ...
                                                <div className="form-col">
                                                    ...
                                                    <Select
                                                        ...
                                                        value={
                                                            MEMBERSHIP_FOR.find(
                                                                (op) => op.value === (membData.membshipFor || 'gift')
                                                            ) || null
                                                        }
                                                        onChange={(selectedOp) => {
