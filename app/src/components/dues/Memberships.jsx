            ...
            <div className="mbrshp-sec">
              <div className="mbrs-col">
                <>
                  ...
                  <div
                    id="ownMembership"
                    style={{ display: isOwnChk ? "block" : "none" }}
                  >
                              ...
                              setMembers((prevItems) =>
                                prevItems.map((mbr) =>
                                  mbr.id === lgMbr
                                    ? {
                                        ...mbr,
                                        planId: selectedOp.membershipTypeId,
                                        subPlanId: null,
                                      }
                                    : mbr
                                )
                ...
                <>
                  ...
                  <div
                    ...
                    id="giftMembership"
                    style={{ display: isGiftChk ? "block" : "none" }}
                  >
                            ...
                            >
                              <div className="info-sec">
                                <div className="person-info">
                                  ...
                                  <div className="mbr-nam">{item.name}</div>
                                </div>
                                ...
                                <div className="form-row">
                                  ...
                                  {subDropItems &&
                                    subDropItems[item.id] &&
                                    subDropItems[item.id].items && (
                                      <div className="form-col">
                                        <label className="fs-16">Amount:</label>
                                        <Select
                                          id="subPlan2"
                ...
                {members && members.length > 0 ? (
                  <div className="order-smry">
                    <div className="ord-itms">
                      <div className="sec-head">Order Summery</div>
                      <div className="list-sec">
                        {members.map((mbr) => {
                          let subttl = 0;
                          subttl =
                            parseFloat(mbr.secDonation || 0) +
                            parseFloat(mbr.natnDonation || 0) +
                            (mbr.subPlanId
                              ? parseFloat(mbr.subPlanId.totalCharges || 0)
                              : 0);
                          ...
                          return (
                            ...
                            >
                              ...
                              <div className="donation-row">
                                <span className="dotn-itm">
                                  Membership Dues/Fees
                                </span>
                                <span className="dotn-amt">
                                  {Pix.dollar(
                                    mbr.subPlanId && mbr.subPlanId.totalCharges
                                      ? mbr.subPlanId.totalCharges
                                      : 0,
                                    1
                                  )}
                                </span>
                              ...
                              {mbr.secDonation ? (
                                <div className="donation-row">
                                  ...
                                  <span className="dotn-amt">
                                    {Pix.dollar(mbr.secDonation || 0, 1)}
                                  </span>
                                </div>
                              ) : (
                                ""
                              ...
                              {mbr.natnDonation ? (
                                <div className="donation-row">
                                  ...
                                  <span className="dotn-amt">
                                    {Pix.dollar(mbr.natnDonation || 0, 1)}
                                  </span>
                                </div>
                              ) : (
                                ""
