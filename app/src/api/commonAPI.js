...
export const signUp = (body) => {
    return axios
        .post(BASE_URL + "/public/?method=signup", body)
        .then((response) => {
...
export const logInViaSMedia = (body) => {
    return axios
        .post(BASE_URL + "/public/?method=login-via-smedia", body)
        .then((response) => {
            return response.data;
        });
};
...
export const login = (body) => {
    return axios
        .post(BASE_URL + "/public/?method=login", body)
        .then((response) => {
            return response.data;
        });
};
...
export const emailLoginReq = (body) => {
    return axios
        .post(BASE_URL + "/public/?method=email-login-request", body)
        .then((response) => {
            return response.data;
        });
};
...
export const verifyOTP = (body) => {
    return axios
        .post(`${BASE_URL}/public/?method=otp-verify`, body)
        .then((response) => {
            return response.data;
        });
};
...
export const getSection = () => {
    setHeaders();
    return axios
        .get(`${BASE_URL}//public/?method=signup-get-section`)
        .then((response) => {
            return response.data;
        });
};
...
export const getAffiliation = () => {
    setHeaders();
    return axios
        .get(`${BASE_URL}//public/?method=signup-get-affiliation`)
        .then((response) => {
            return response.data;
        });
};

export const getCollegiateDropdown = () => {
    setHeaders();
    return axios
        .get(`${BASE_URL}//public/?method=collegiate-sections-fetch`)
        .then((response) => {
            return response.data;
        });
};
